  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (msg.includes('Invalid login credentials')) {
        ...
        Alert.alert('Account esistente', 'Esiste già un account con questa email. Prova ad accedere.');
      } else if (msg.includes('Email not confirmed')) {
        Alert.alert('Email non confermata', 'Controlla la tua casella di posta e clicca sul link di conferma.');
      } else {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        >
          ...
          {/* Segmented control Login / Registrati */}
